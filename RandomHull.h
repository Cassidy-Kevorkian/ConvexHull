...
void process_ridge_sequential(const Edge &t1, const Point &r,
                                const Edge &t2,
                                const std::vector<Point> &points);
...
void process_other_ridge_sequential(
    ...
    const std::vector<Point>
        &points); // namespace random_hull_testing
std::set<random_hull::Edge> __convex_hull__sequential(
    const std::vector<Point> &points);
void print_ridge(const random_hull::Edge &t1, const random_hull::Edge &t2, const Point &r);
} // namespace random_hull
// namespace random_hull
