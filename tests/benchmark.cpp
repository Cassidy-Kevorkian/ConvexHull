...
void run_file(const std::string& file_name){
    ...
    std::ofstream file1(file_name.substr(0, file_name.length() - 4) + "_GS.txt");
    if (!file1.is_open())
    {
    ...
    std::ofstream file2(file_name.substr(0, file_name.length() - 4) + "_QH.txt");
    if (!file2.is_open())
    {
    ...
    std::ofstream file3(file_name.substr(0, file_name.length() - 4) + "_QHP.txt");
    if (!file3.is_open())
    {
