...
void QuickHullRec(Point p, Point q, std::vector<Point> points, std::vector<Point> &answer) {
    ...
    QuickHullRec(p, furthest_point, points_1, answer); 
    QuickHullRec(q, furthest_point, points_2, answer); 
}
...
std::vector<Point> QuickHull(std::vector<Point> points) {
    ...
    QuickHullRec(lowest_point, highest_point, points_1, answer);
    QuickHullRec(lowest_point, highest_point, points_2, answer);
